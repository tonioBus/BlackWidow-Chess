...
public class MCTSExerciceTest {
    ...
    void CACAtestEndWithBlackPromotion(int nbStep) throws Exception {
        ...
        final MCTSStrategy blackStrategy = new MCTSStrategy(
                ...
                .withNbSearchCalls(nbStep);
        game.setup(whiteStrategy, blackStrategy);
        nnBlack.addIndexOffset(2F, "a3-a2", Piece.PieceType.PAWN);
        nnBlack.addIndexOffset(1F, "a2-a1", Piece.PieceType.PAWN);
    ...
    void testOneShotBlackChessMate(int nbStep) throws Exception {
    ...
    @ParameterizedTest
    @ValueSource(ints = {200, 400, 800})
    void testAvoidEndWithWhitePromotion(int nbStep) throws Exception {
