...
import com.aquilla.chess.strategy.mcts.CacheValues;
import com.aquilla.chess.strategy.mcts.MCTSNode;
import com.aquilla.chess.strategy.mcts.PolicyUtils;
...
public class DotGenerator {
    ...
    private String values(final MCTSNode node) {
        ...
        synchronized (values) {
            for (MCTSNode.PropragateValue propragateValue : values) {
