...
import com.aquila.chess.strategy.mcts.nnImpls.NNBasic;
...
public class MainAGZvsBasic {
    ...
    private static final String trainDir = "train-AGZvsBasic";

    @SuppressWarnings("InfiniteLoopStatement")
    public static void main(final String[] args) throws Exception {
        GameManager gameManager = new GameManager("../AGZ_NN/sequences-AGZvsBasic.csv");
        ...
        INN nnBlack = new NNBasic(Alliance.BLACK, System.currentTimeMillis());
